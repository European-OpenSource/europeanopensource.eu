...
# Description: Script to import and convert JSON database entries to Markdown format and save them into the lib/website/src/content/project directory.
...
convert_json_to_md() {
  ...
  local md_file="${ROOT_PATH}/lib/database/projects/$(basename "${filename}" .json).md"
...
main() {
  ...
  local metadata_file="${ROOT_PATH}/lib/website/src/content/metadata.json"
